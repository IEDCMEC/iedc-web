        ...
        <section id="box_curve_top">
          ...
          <div className='contact container' id="centre_mobile">
            <div className="row" >
              ...
              <div className="col s12 m4 l6  margin_top_mobile  center-align" id="follow-us">
                <h4 id="bottom_margin" className="center-alingnment">Follow Us</h4>
                <div className="col s12 m10">

                  <div className="row" >
                    <a href="" style={{ 'color': '#C33427' }} id="icon_space"><i className="fab circle fa-facebook fa-2x" ></i></a>
                    <a href="" style={{ 'color': '#C33427' }} id="icon_space"><i className="fab circle fa-twitter fa-2x"></i></a>
                    <a href="" style={{ 'color': '#C33427' }} id="icon_space"><i className="fab circle fa-linkedin fa-2x"></i></a>
                    <a href="" style={{ 'color': '#C33427' }} id="icon_space"><i className="fab circle fa-google-plus fa-2x"></i></a>
                    <a href="" style={{ 'color': '#C33427' }} id="icon_space"><i className="fab circle fa-pinterest fa-2x"></i></a>
                  </div>
