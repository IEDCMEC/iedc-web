      ...
      <div className="row" >
        <div className="col s12 m6 mr2" style={{ height: '60vh', display: 'flex', flexDirection: 'column', justifyContent: 'center' }} >
          ...
          <div className="row" style={{ display: 'flex', 'justifyContent': 'space-evenly', marginTop: '20px' }} >
            <a href="https://www.instagram.com/iedcmec/" className='icon-link'><i className="fa fa-instagram" aria-hidden="true"></i></a>
            <a href="https://www.linkedin.com/company/iedcmec/" className='icon-link'><i className="fa fa-linkedin" aria-hidden="true"></i></a>
            <a href="https://twitter.com/iedc_mec" className='icon-link'><i className="fa fa-twitter" aria-hidden="true"></i></a>
          </div>
        </div>
