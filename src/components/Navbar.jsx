...
const Navbar = () => {
  ...
  useEffect(() => {
    setSidenavInstance(M.Sidenav.init(sidenavRef.current, {
      outDuration: 400
    }))
  }, [])
        ...
        <nav className="nav-wrapper z-depth-0 accent-1 nav_img">
          <div className="container" style={{ display: 'flex' }} >
            <a href="#" data-target="mobile-nav" className="sidenav-trigger">
              <i className="material-icons" style={{ color: "#BF2200" }}>menu</i>
            </a>
            ...
            }} ><span style={{ color: '#BF2200' }} >IEDC</span>MEC</div>
            <ul className="hide-on-med-and-down" style={{ display: 'flex', flex: '1', justifyContent: 'space-between' }} >
              ...
              <li key="projects">
                  <a href="https://github.com/IEDCMEC/projects/blob/main/README.md" className='black-text '>Projects</a>
                </li>
            </ul>
          </div>
        </nav>
