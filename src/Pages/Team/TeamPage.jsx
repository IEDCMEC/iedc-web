...
import { executiveMembers, webTeam, advisoryBoard,ex_executiveMembers_2021,ex_executiveMembers_2022,ex_executiveMembers_2023,ex_executiveMembers_2024,ex_executiveMembers_2025 } from './MembersList'
...
const TeamPage = () => {
   return (
      <div id='team-page' >
            ...
            <AccordionItemPanel>
               <div className="row" id="executive-members-list">
                  {ex_executiveMembers_2025.map(({ id, ...otherProps }) => (
                  <Card key={id} spacingId={id} {...otherProps} />
                  ))}
               </div>
               <br />
         ...
         {ex_executiveMembers_2024.map(({ id, ...otherProps }) => (
            <Card key={id} spacingId={id} {...otherProps} />
         ))}
